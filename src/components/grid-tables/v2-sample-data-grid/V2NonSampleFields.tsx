...
// Legacy component - not used in V2 implementation
interface V2NonSampleFieldData {
    id: string;
    fieldName: string;
    value: string;
    confidence: number;
...
interface V2NonSampleFieldsProps {
    nonSampleData: V2NonSampleFieldData[];
    onFieldChange?: (sectionType: string, index: number, value: string) => void;
    onRemoveField?: (sectionType: string, index: number) => void;
}

export const V2NonSampleFields: React.FC<V2NonSampleFieldsProps> = ({
    nonSampleData,
    onFieldChange,
    onRemoveField,
}) => {
